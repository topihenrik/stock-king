...
const initTestDB = async () => {
    ...
    const createCompany = 'CREATE TABLE Company(cid INT PRIMARY KEY GENERATED ALWAYS AS IDENTITY, ticker TEXT UNIQUE NOT NULL, name TEXT NOT NULL, market_cap BIGINT NOT NULL, currency TEXT NOT NULL, date DATE NOT NULL, sector TEXT NOT NULL);';
